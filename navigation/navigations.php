...
<title><?php echo $title;?> | EASY LEARN </title>
...
<section id="title-header">
  <div class="title">  
     <img class="logo" >EASY LEARN 
      <p class="subtitle"> LEARN AT YOUR OWN PACE, IN YOUR OWN SPACE </p> 
  </div>
</section>  
<section id="navigation">
  <div id="mySidenav" class="sidenav">
    <a href="<?php echo web_root; ?>index.php?q=lesson" id="lesson">Courses <i class="fa fa-home pull-right"></i></a> 
