...
<div class="navbar-header">
  ...
  <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >EASY LEARN </a>
</div>
...
<div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            ...
            <!--     <li>
                ...
                <li>
                     <a href="<?php echo web_root; ?>admin/modules/lesson/index.php"><i class="fa fa-user fa-fw"></i> Courses </a> 
                </li>
                 <li>
...
<section id="page-footer"> 
      <footer>  <p>&copy;  Easy Learn  </p></footer>
</section>
<!-- Plugins -->
